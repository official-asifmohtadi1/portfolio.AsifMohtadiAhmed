        ...
        <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden">
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8 relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-2.5 py-1.5 sm:px-3 sm:py-1 rounded-full bg-slate-800/50 border border-slate-700/50 text-xs sm:text-sm font-medium mb-6">
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                            </span>
                            <span className="truncate max-w-[200px] sm:max-w-none">Available for Freelance & Strategic Roles</span>
                        </div>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold font-heading leading-[1.1] mb-6">
                            Architecting <br className="hidden sm:block" />
                            <span className="text-gradient">Digital Success.</span>
                        </h1>
                        
                        {/* Mobile and Tablet Image (Displays before bio paragraph) */}
                        <div className="block lg:hidden relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full p-1 z-10 mx-auto mb-8"
                    ...
                    >
                        <Link
                            href="#portfolio"
                            className="px-8 py-3.5 rounded-full bg-white text-slate-950 font-bold hover:bg-slate-200 transition-colors flex justify-center items-center gap-2 group w-full sm:w-auto text-sm sm:text-base"
                        >
                            View My Work
                        ...
                        <a
                            ...
                            download
                            className="px-8 py-3.5 rounded-full bg-slate-800 text-white font-medium hover:bg-slate-700 border border-slate-700 transition-all flex justify-center items-center gap-2 w-full sm:w-auto text-sm sm:text-base"
                        >
                            <Download size={18} />
                            Download CV
                        </a>
                ...
                >
                    ...
                    {/* Main Visual */}
                    <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full p-1 z-10 mx-auto"
                        style={{ background: "linear-gradient(135deg, #10b981, #0ea5e9, #6366f1)" }}>
                        {/* Spinning ring accent */}
                        <div className="absolute inset-0 rounded-full border-2 border-dashed border-emerald-500/30 animate-spin" style={{ animationDuration: "20s" }} />
                        <div className="w-full h-full rounded-full bg-slate-900 overflow-hidden relative shadow-2xl border-2 border-slate-800">
