        ...
        <div className="max-w-5xl mx-auto py-10 px-6">
            ...
            <div className="mb-12">
                <h1 className="text-4xl font-bold font-heading mb-4 flex items-center gap-4">
                    ...
                    Add New <span className="text-gradient">Portfolio Project</span>
                </h1>
                <p className="text-slate-400 text-lg">Add a new masterpiece to your professional showcase.</p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            type="text"
                            required
                            className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-emerald-500 transition-all outline-none text-xl font-bold text-white placeholder-slate-700"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="github" name="github" className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-emerald-500 transition-all outline-none text-sm text-white" placeholder="https://github..." />
                            </div>
                            <div>
                                ...
                                <input id="live" name="live" className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-emerald-500 transition-all outline-none text-sm text-white" placeholder="https://..." />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input id="images" name="images" className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-emerald-500 transition-all outline-none text-white text-sm" placeholder="url1, url2, url3" />
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 grid md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <textarea id="problem" name="problem" rows={4} className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-red-500 transition-all outline-none text-sm text-slate-300" placeholder="What was the core problem to solve?" />
                        </div>
                        <div>
                            ...
                            <textarea id="solution" name="solution" rows={4} className="w-full px-6 py-4 rounded-2xl bg-slate-900/50 border border-slate-800 focus:border-emerald-500 transition-all outline-none text-sm text-slate-300" placeholder="How did you solve it?" />
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <textarea
                            ...
                            name="content"
                            rows={6}
                            className="w-full px-8 py-6 rounded-[2rem] bg-slate-950 border border-slate-800 focus:border-emerald-500 outline-none font-mono text-sm text-emerald-100 placeholder-slate-800"
                            placeholder="Any other technical details or insights..."
                        />
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-slate-800/50">
                    ...
                    >
                        {isLoading ? <Loader2 className="animate-spin" size={24} /> : (
                            <>Save Project & Publish <Save size={24} /></>
                        )}
                    </button>
                </div>
            </form>
